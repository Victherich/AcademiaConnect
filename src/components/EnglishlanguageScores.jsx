// src/pages/TeacherEnterScores.js
...
const EnglishLanguageScores = () => {
    ...
    return (
        <div className="enter-scores-container">
            <h2 className="enter-scores-title">Enter Scores for English Language</h2>
...
export default EnglishLanguageScores;
